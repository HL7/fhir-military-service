...
* component[odh-Industry].value[x] from 2.16.840.1.114222.4.5.327
 
* component[odh-SupervisoryLevel].code =  LNC#87707-6
* component[odh-SupervisoryLevel].value[x] only CodeableConcept
* component[odh-SupervisoryLevel].value[x] 0..1
* component[odh-SupervisoryLevel].value[x] from  2.16.840.1.114222.4.11.7613


* value[x] only CodeableConcept 
* value[x] from 2.16.840.1.114222.4.11.7901
