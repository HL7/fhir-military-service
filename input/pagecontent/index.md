...
This use cases requires a custom operation:
**Operation**: \$**veteranStatus** returns true if a patient is a Veteran, false otherwise, 
...
The Employment Episode profile is the base profile for [Military Service
...
|        Operation          |  **Notes**                                                                                                                       |
|---------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **veteranStatus** boolean |  This extension is a boolean flag used to specify/store the confirmation/verification status. true: the Patient record describes a Veteran or false: the Patient is either not a verified yet or under review if the flag is absent, then the veteran status is undetermined. |
...
a newly defined [Employment History Episode](#employment-history-episode)
...
require any information regarding the job performed by the Veteran during their service.
...
information this profile is more generic than that specified in ODH.
...
| **category** CodeableConcept | [1...1]              | "social-history" - fixed value for this profile.                                                                                                                                                                                       |
