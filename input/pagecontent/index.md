...
| **url** url                          | [1...1]                            | Profile canonical url used to reference this profile in an Observation that conforms this profile. Fixed value in the {StructureDefinition.url} to the value 'http://hl7.org/fhir/StructureDefinition/employment-episode' 
Path: **Observation.meta.profile** This profile may be used along with other profiles met by the Observation resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
*abstract* profile. This profile is similar **ODH Past or Present Job** profile
...
profile to apply it specifically to military jobs/occupations.

One or more military occupations may be referenced by a single Military Service
History record.
...
In the future, the [MissionCode](#missioncode) may also need a SNOMED CT
...
[Industry CDC NAICS 2012 (ODH)](#industry-CDC-NAICS-2012-(ODH)).
...
Supervisory Level or Pay Grade](#job-supervisory-level-or-pay-grade-(ODH)).
...
-   [US Veteran](\#US Veteran) specifies a flag to indicate the veteran status
    as a boolean value.
