...
Parent:   OccupationalObservation
...
* component[mseo-DischargeStatus].code =  http://loinc.org#xxx "Discharge Status"
...
* component[mseo-SeparationReason].code =  http://loinc.org#xxx "Separation Reason "
